# bce69d3b-7af4-429e-80af-af64c3051ba1 implementation handoff

This archive is the source of truth for turning the design into production code. Start from `qiyas-badge-exam.html`, then preserve the visual system, responsive behavior, and interactions found in the exported files.
...
## Source map
- Primary entry: `qiyas-badge-exam.html`
...
- A single self-contained `qiyas-badge-exam.html` is acceptable only when the export truly contains one user-facing screen and its CSS/JS are structured enough to extract tokens, components, states, and behavior.
...
1. Open `qiyas-badge-exam.html` and `DESIGN-MANIFEST.json`; identify every screen file, launcher/overview file, app module, and interaction before coding.
...
## Entry points
- `qiyas-badge-exam.html`
- `qiyas-design-system.html`
- `qiyas-forgot-password.html`
- `qiyas-learning-library.html`
- `qiyas-parent-add-student.html`
- `qiyas-parent-dashboard.html`
- `qiyas-parent-login.html`
- `qiyas-parent-signup.html`
- `qiyas-results-explanations.html`
- `qiyas-role-picker.html`
- `qiyas-splash-screen.html`
- `qiyas-student-dashboard.html`
- `qiyas-student-signin.html`
- `qiyas-taking-test.html`
...
- `drawing-2026-08-25T01-41-10-040Z.png`
- `drawing-2026-08-25T14-50-53-309Z.png`
- `drawing-2026-08-27T07-09-49-589Z.png`
- `qiyas-screen-handoff-rules.md`
- `screenshot-2026-08-25T01-40-20-696Z.png`
- `screenshot-2026-08-25T01-40-23-341Z.png`
- `screenshot-2026-08-25T01-40-27-718Z.png`
- `screenshot-2026-08-25T08-32-45-618Z.png`

## Coding checklist for AI tools
1. Inspect `qiyas-badge-exam.html` and `DESIGN-MANIFEST.json` first and identify reusable components before coding.
